...
import { calculateTick, calculateTickDelta, getMaxTick, getMinTick } from '@invariant-labs/alph-sdk'
      ...
      <Grid className={classes.topInnerWrapper}>
        ...
        <Grid className={classes.infoWrapper}>
          <Typography className={classes.info}>
            ...
            enter the amount of tokens. The estimated cost of creating a pool is up to 1.25 ALPH.
          </Typography>
        </Grid>
